...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "LearnOpenGL - 3D Sphere", NULL, NULL);
	if (!window)
	{
	...
	{
		std::cout << "FAILED TO LOAD FUNCTION POINTERS PROCCESS IN GLAD" << std::endl;
		return -1;
	}
